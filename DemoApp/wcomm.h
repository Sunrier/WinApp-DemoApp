...
/***********************************************************************************************
	FuncName : WComm_DispDescpFromCode
	...
	Other    : None
*************************************************************************************************/
EXPORT unsigned char *WComm_DispDescpFromCode(unsigned char ucRetCode);
...
/***********************************************************************************************
	FuncName : WComm_GetRevisionInfo
	FuncFunc : 获取库版本修订信息
	...
	Other    : None
*************************************************************************************************/
EXPORT unsigned char WComm_GetRevisionInfo(unsigned char *pucOutputData,unsigned int *puiOutputDataLen);
...
/***********************************************************************************************
	...
	Other    : None
*************************************************************************************************/
EXPORT unsigned char WComm_GetLibVersion(unsigned char *pucOutputData,unsigned int *puiOutputDataLen);
